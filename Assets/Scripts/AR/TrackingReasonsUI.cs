...
public class TrackingReasonsUI : MonoBehaviour
{
    [SerializeField]
    ...
    public Sprite m_InitRelocalSprite;
    const string k_MotionText = "Try moving at a slower pace.";
    public Sprite m_MotionSprite;
    ...
    public Sprite m_FeaturesSprite;
    const string k_UnsupportedText = "AR content is not supported.";
    public Sprite m_UnsupportedSprite;
